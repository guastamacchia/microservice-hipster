package org.atsaug.microservice.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("microserviceHipster");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("microserviceHipster");
        ...
        config.getMapConfigs().put("org.atsaug.microservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
