...
@RestController
@RequestMapping("/api/microservice-hipster-kafka")
public class MicroserviceHipsterKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MicroserviceHipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroserviceHipsterKafkaResource(KafkaProperties kafkaProperties) {
