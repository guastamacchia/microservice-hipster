...
import org.atsaug.microservice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link org.atsaug.microservice.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "microserviceHipsterJobHistory";
