...
class DepartmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Department entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservicehipster/api/departments")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new department")
            .post("/services/microservicehipster/api/departments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/microservicehipster${new_department_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created department")
            .delete("/services/microservicehipster${new_department_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
