...
class RegionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Region entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservicehipster/api/regions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new region")
            .post("/services/microservicehipster/api/regions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/microservicehipster${new_region_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created region")
            .delete("/services/microservicehipster${new_region_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
