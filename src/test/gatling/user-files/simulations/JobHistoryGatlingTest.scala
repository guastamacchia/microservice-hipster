...
class JobHistoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the JobHistory entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservicehipster/api/job-histories")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new jobHistory")
            .post("/services/microservicehipster/api/job-histories")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/microservicehipster${new_jobHistory_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created jobHistory")
            .delete("/services/microservicehipster${new_jobHistory_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
