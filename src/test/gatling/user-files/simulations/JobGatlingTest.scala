...
class JobGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Job entity")
        ...
        .repeat(2) {
            ...
            .get("/services/microservicehipster/api/jobs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new job")
            .post("/services/microservicehipster/api/jobs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/microservicehipster${new_job_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created job")
            .delete("/services/microservicehipster${new_job_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
