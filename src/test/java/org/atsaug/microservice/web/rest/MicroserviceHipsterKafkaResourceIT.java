...
import org.atsaug.microservice.config.KafkaProperties;
...
class MicroserviceHipsterKafkaResourceIT {
    ...
    void setup() {
        ...
        MicroserviceHipsterKafkaResource kafkaResource = new MicroserviceHipsterKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/microservice-hipster-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/microservice-hipster-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
